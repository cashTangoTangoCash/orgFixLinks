...
<edge COLOR="#ffff00"/>
<node TEXT="sweigart automate the boring stuff" ID="ID_845450460" CREATED="1482611728148" MODIFIED="1482611733450"/>
...
<node TEXT="" ID="ID_1034167020" CREATED="1482611719892" MODIFIED="1482611719892"/>
...
<node TEXT="why orgFixLinks.py?" POSITION="left" ID="ID_207969756" CREATED="1482612959364" MODIFIED="1482614273298">
<edge COLOR="#0000ff"/>
<node TEXT="idea came from twitter scraper in severance" ID="ID_1204900561" CREATED="1482604684677" MODIFIED="1482612965349"/>
<node TEXT="broken links in my org files are a pain" ID="ID_921133748" CREATED="1482612967724" MODIFIED="1482612979594">
<node TEXT="wanting to make notes but getting derailed by broken links" ID="ID_983864292" CREATED="1482612981403" MODIFIED="1482612993059"/>
</node>
...
<node TEXT="the links" POSITION="left" ID="ID_1951756195" CREATED="1482611984971" MODIFIED="1482611986722">
<edge COLOR="#7c007c"/>
...
<node TEXT="an org file where you simply type in various links and observe how org treats them" ID="ID_658117180" CREATED="1482613035978" MODIFIED="1482613055441"/>
</node>
...
<node TEXT="giving my tiny brain fits" ID="ID_1532964057" CREATED="1482604469299" MODIFIED="1482604480125"/>
...
<node TEXT="I like this index of links and tags" ID="ID_80153451" CREATED="1482614455856" MODIFIED="1482614465247"/>
<node TEXT="code should be revised so this is optional, because many users probably will dislike it" ID="ID_115589375" CREATED="1482614465497" MODIFIED="1482614490350"/>
</node>
...
<node TEXT="github is smarter but more complex" ID="ID_637773300" CREATED="1482604847020" MODIFIED="1482604860874"/>
</node>
...
<node TEXT="operates via git" ID="ID_1227062581" CREATED="1482613253922" MODIFIED="1482613259031"/>
</node>
...
<edge COLOR="#7c007c"/>
<node TEXT="adding a database to this code drastically slowed things down and increased the difficulty" ID="ID_945220435" CREATED="1482611765595" MODIFIED="1482611781210"/>
